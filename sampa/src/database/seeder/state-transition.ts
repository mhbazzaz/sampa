...
const stateTransitions: {
  ...
  },
  {
    process: ProcessEnum.AssessmentLayer,
    currentState: 'approved',
    nextState: 'SAM assigned',
    action: ActionEnum.ApprovedAssignSAM,
  },
  {
    process: ProcessEnum.AssessmentLayer,
    currentState: 'SAM assigned',
    nextState: 'SAM assigned', // self-loop
    action: ActionEnum.SAMAssignedAssignSAM,
  },
  {
    process: ProcessEnum.AssessmentLayer,
    currentState: 'SAM assigned',
    nextState: 'supervised',
    action: ActionEnum.SAMAssignedAddSupervise,
  },
  {
    process: ProcessEnum.AssessmentLayer,
  ...
  },
  {
    ...
    nextState: 'layerAssessmentReviewBySAM',
    action: ActionEnum.LayerAssessmentCompletedAccept,
  },
  {
    process: ProcessEnum.AssessmentLayer,
    currentState: 'layerAssessmentReviewBySAM',
    nextState: 'layerAssessmentReviewBySAMDone',
    action: ActionEnum.LayerAssessmentReviewAcceptBySAM,
  },
  {
    process: ProcessEnum.AssessmentLayer,
    currentState: 'layerAssessmentReviewBySAM',
    nextState: 'layerAssessmentCompleted',
    action: ActionEnum.LayerAssessmentReviewNeedModificationsBySAM,
  },
  {
    process: ProcessEnum.AssessmentLayer,
    currentState: 'layerAssessmentCompleted',
  ...
  {
    process: ProcessEnum.AssessmentLayer,
    currentState: 'layerAssessmentReviewBySAMDone',
