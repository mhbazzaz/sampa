...
export class AssetRepository extends AbstractRepository<Asset> {
  ...
  async createAssetWithVersions(
    ...
    const {
      ...
      editorUnitId,
      accountableDeputyId,
      accountableDeputyName,
      accountableManagementId,
      accountableManagementName,
      accountableGroupId,
      accountableGroupName,
      editorDeputyId,
      editorDeputyName,
      editorManagementId,
      editorManagementName,
      editorGroupId,
      editorGroupName,
      financialScore,
      reputationScore,
    ...
    try {
      ...
      if (!onlyRelationChanged) {
        ...
        const newAssetVersion = await queryRunner.manager.save(AssetVersion, {
          ...
          accountableUnitId:
            accountableUnitId || oldAssetVersion.accountableUnitId,
          accountableDeputyId: oldAssetVersion.accountableDeputyId,
          accountableDeputyName: oldAssetVersion.accountableDeputyName,
          accountableManagementId: oldAssetVersion.accountableManagementId,
          accountableManagementName: oldAssetVersion.accountableManagementName,
          accountableGroupId: oldAssetVersion.accountableGroupId,
          accountableGroupName: oldAssetVersion.accountableGroupName,
          editorId: editorId || oldAssetVersion.editorId,
          editorUnitId: editorUnitId || oldAssetVersion.editorUnitId,
          editorDeputyId: oldAssetVersion.editorDeputyId,
          editorDeputyName: oldAssetVersion.editorDeputyName,
          editorManagementId: oldAssetVersion.editorManagementId,
          editorManagementName: oldAssetVersion.editorManagementName,
          editorGroupId: oldAssetVersion.editorGroupId,
          editorGroupName: oldAssetVersion.editorGroupName,
          assetId: oldAssetVersion.asset.id,
          updateUserId: user.id,
          status: oldAssetVersion.assetTypeVersion?.classification
            ? AssetStatusEnum.Pending
            : undefined,
          ...scores,
          evaluationScore: evaluationScore,
        });
        ...
        try {
          await ElasticsearchClient.instance.client.index({
            ...
            body: {
              ...
              accountableManagementId: oldAssetVersion.accountableManagementId,
              accountableManagementName:
                oldAssetVersion.accountableManagementName,
              accountableGroupId: oldAssetVersion.accountableGroupId,
              accountableGroupName: oldAssetVersion.accountableGroupName,
              editorId: editorId || oldAssetVersion.editorId,
              editorUnitId: editorUnitId || oldAssetVersion.editorUnitId,
