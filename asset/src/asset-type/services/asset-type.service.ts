...
export class AssetTypeService {
  ...
  private static readonly INVERSE_RELATION_MAP: Partial<
    Record<RelationDirectionType, RelationDirectionType | null>
  > = {
    ...
    if (hasNonContentUpdates && (content === undefined || isSameContent)) {
      await this.assetTypeRepository.update(
        { id: assetTypeId },
        {
          ...
          isShareable: isShareable ?? existingAssetType.isShareable,
